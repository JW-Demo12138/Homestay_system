          ...
          <el-card class="form-card">
            <template #header>
              <div class="card-header">
                <h3>体验项目信息</h3>
                <span class="card-tip">填写乡村特色体验项目的详细信息</span>
              </div>
            </template>
            ...
            <el-form-item label="关联民宿" prop="homestayId">
              ...
              <div class="input-suggestion">
                选择体验项目关联的民宿，方便用户在查看民宿时也能看到相关的体验项目
              </div>
            </el-form-item>
...
const handleSubmit = async () => {
  try {
    ...
    const result = await experienceAPI.create(form)
    console.log('体验项目创建结果:', result)
